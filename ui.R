...
ui <- fluidPage(theme = bs_theme(bootswatch = "sandstone"),
  ...
  fluidRow(
    ...
    column(width = 6,h2("Delegate Network Visualization Based on Voting Patterns"),align="center"),
  ...
  tabsetPanel(
    tabPanel("Delegate Networks Clusters",
      ...
      sidebarLayout(
        ...
        mainPanel(width=9,
          column(width = 12,p("Node Size is based on Number of votes by the Delegate while Node color shows the number of delegators for a Delegate"),align="center"),
